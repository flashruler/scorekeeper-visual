    ...
    return (
        <div className="bg-green-500">
            <div className="grid grid-cols-7 grid-rows-5 h-screen">
                ...
                <div className="row-start-1 row-end-6 col-span-2 bg-gray-600">
                    <div className="grid grid-rows-5 h-screen items-center">
                        ...
                        <div className="row-start-3 row-span-1 p-8">
                ...
                <div className="col-end-8 row-start-1 row-span-4 col-span-5">

                    <div className="flex flex-col p-16 space-y-2">
                        <h1 className="text-center text-5xl italic text-white">Schedule of Events</h1>
                        <h1 className="text-white italic text-3xl">On The Field</h1>
                        <MatchupComponent />
                        <h1 className="text-white italic text-3xl">Queuing area</h1>
                        <MatchupComponent />
                    </div>
                </div>
